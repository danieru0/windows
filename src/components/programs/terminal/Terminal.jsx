...
import { help, echo, author, calculator, touch, whoami, ls, rm, href, rename, passfile, passfilerm } from '../../../store/actions/terminal';
...
export default connect(mapStateToProps, { help, echo, author, calculator, touch, whoami, ls, rm, href, rename, passfile, passfilerm, removeRunningAppFromLocalStorage, toggleMinimalizeApp })(Terminal);