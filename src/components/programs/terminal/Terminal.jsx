...
import { help, echo, author, calculator, touch, whoami, ls, rm, href, rename, passfile, passfilerm, kill, date } from '../../../store/actions/terminal';
...
export default connect(mapStateToProps, { help, echo, author, calculator, touch, whoami, ls, rm, href, rename, passfile, passfilerm, kill, date, removeRunningAppFromLocalStorage, toggleMinimalizeApp })(Terminal);